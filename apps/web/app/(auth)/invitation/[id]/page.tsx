  ...
  return (
    <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-sm">
        <h2 className="mt-6 text-center font-bold text-3xl tracking-tight">You've been invited</h2>
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        {invitation.status === "accepted" && (
          <Alert variant="default">
            <CheckCircle2Icon />
            <AlertTitle>
              The invitation to join "{invitation.organizationName}" has been accepted.
            </AlertTitle>
          </Alert>
        )}
        <InvitationButtons
