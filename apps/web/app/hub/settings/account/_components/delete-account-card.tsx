							...
							<div className="flex flex-col items-center gap-3 sm:flex-row sm:items-start">
								...
								<div className="flex flex-col gap-1">
									...
									<AlertDialogDescription>
										...
										organizations. In addition, your owned organizations will
										also be permanently deleted and other members and their
						...
						<AlertDialogFooter className="mt-2">
							...
							>
								<LoadingSwap isLoading={false}>
									Delete your account and {ownedOrganizations.length}{" "}
									organizations
								</LoadingSwap>
							</Button>
						</AlertDialogFooter>
