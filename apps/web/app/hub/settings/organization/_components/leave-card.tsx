...
export const LeaveCard = ({ organization }: { organization: Auth["$Infer"]["Organization"] }) => {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Leave your organization and remove your access to it.</CardDescription>
      </CardHeader>
      <CardContent>
        <ActionButton
