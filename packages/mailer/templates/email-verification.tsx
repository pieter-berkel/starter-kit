...
const EmailVerificationEmail = ({ link, name }: EmailVerificationEmailProps) => {
        ...
        <Body className="bg-gray-100 py-2.5">
          <Container className="max-w-[600px] bg-white p-12">
            ...
            <Text className="my-6 text-base">
              Thank you for signing up for Starter Kit. Please click the button below to verify your
              email address.
            </Text>
            <Button
